...
const InvoiceBlmBayar = () => {
  ...
  const fetchData = async () => {
    await axios
      .get(HOST + "/finance/invoice/getBlmBayar", {
        headers: {
  ...
  useEffect(() => {
    if (getActionButton === "update" && id !== 0) {
      ...
      navigate("/dashboard/pembayaran/input/" + id);
    }
  }, [id, getActionButton]);
  ...
  return (
    <div>
      ...
      <div className="m-2 md:m-10 mt-24 px-2 py-10 md:p-10 bg-white rounded-3xl">
        <Header title="Invoice Belum Bayar" />
...
export default InvoiceBlmBayar;
